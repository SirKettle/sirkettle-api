...
app.get('/', function (req, res) {
    res.send("\n    <html>\n      <head>\n      <title>" + package_json_1.default.name + "</title>\n      </head>\n      <body>\n        <h1>Available endpoints</h1>\n        <ul>\n          <li>GET " + exports.linkHtml('/pie') + " (returns a random, but always delicious, pie)</li>\n          <li>GET " + exports.linkHtml('/ipv4') + "</li>\n          <li>GET " + exports.linkHtml('/twitter/tweets/:userId', '/twitter/tweets/ffc_the?count=5') + "</li>\n          <li>GET " + exports.linkHtml('/twitter/legacy-tweets/:userId', '/twitter/legacy-tweets/ffc_the?count=5') + "</li>\n          <li>GET " + exports.linkHtml('/twitter/legacy-tweets', '/twitter/legacy-tweets?user=ffc_the&count=5') + " (requires a ?user=query)</li>\n          <li>GET " + exports.linkHtml('/events/:appId', '/events/loisthirkettle') + "</li>\n          <li>GET " + exports.linkHtml('/events/:appId/:eventId', '/events/loisthirkettle/designermakers21') + "</li>\n          <li>GET " + exports.linkHtml('/events/:appId/:eventId', '/events/loisthirkettle/designermakers21') + "</li>\n          <li>GET " + exports.linkHtml('/blog/posts-and-tweets', '/blog/posts-and-tweets?tumblr_id=thefittedfurnitureco&twitter_id=ffc_the') + "</li>\n          <li>GET " + exports.linkHtml('/blog/posts/:userId', '/blog/posts/sirkettle?type=photo&count=2') + "</li>\n        </ul>\n      </body>\n    </html>\n  ");
});
